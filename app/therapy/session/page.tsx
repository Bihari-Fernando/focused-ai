    ...
    <div className="relative max-w-7xl mx-auto px-4 mt-20">
      <div className="flex h-[calc(100vh-4rem)]">
        <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-background rounded-lg border">
          ...
          {/* form to submit chat */}
          <div className="border-t bg-background/50 backdrop-blur supports-[backdrop-filter]:bg-background/50 p-4"></div>
          <form
            onSubmit={() => {}}
            className="w-full px-6 mx-auto flex gap-4 items-end relative"
          >
